...
public partial class VehicleRentalDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.InvoiceId).HasName("PK__Invoices__D796AAD5157A4F81");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A584816B60A");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__Rentals__97005963C2560A08");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasMany(d => d.Rentals).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("UserId", "RentalId").HasName("PK__RentalUs__3EF8C93A23CC1944");
